# 偽金鑰性質為何至今沒有公鑰版：AK21 Def 16 的結構性障礙、公鑰 UE 的替代範式盤點與古典可模糊性概念在 UE 證明中的角色

> **更正（2026-07-12）**：本報告的核心判斷有一個重大遺漏——[HKNY24]（Hiroka-Kitagawa-Nishimaki-Yamakawa，arXiv:2311.09487，TCC 2024）**Appendix E** 已經在不使用 FE 的情況下，用**接收者非承諾加密（RNCE）**從 one-time unclonable SKE + PKE 構造出公鑰 UE，且證明 unclonable-IND 保持（Lemma E.2）。「偽金鑰性質沒有公鑰形式化」字面上仍成立，但其實質內容（trapdoored 可模糊化路線）已被該附錄做掉；下文「六種替代範式」應為七種。詳見 `AK21_Close_Reading_Slot_Interfaces_and_Route_Candidates.md` §3。
